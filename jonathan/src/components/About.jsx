...
const About = () => {
  ...
  return (
    <section id="about" className="container mx-auto px-4 py-16" style={{ backgroundColor: '#EDE0D0' }}>
      <motion.h2 
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          <h3 className="text-xl font-semibold mb-4 text-black" style={{ fontFamily: "'Courier New', Courier, monospace" }}>
            Mon Parcours
          </h3>
